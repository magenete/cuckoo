...
cuckoo_variables()
{
    ...
    CUCKOO_ETC_ICONS_DIR="${CUCKOO_ETC_DIR}icons/"
    ...
    CUCKOO_LAUNCHERS_DESKTOP_ARCH_DIR="${CUCKOO_LAUNCHERS_DESKTOP_DIR}${CUCKOO_ARCH}/"
    CUCKOO_LAUNCHERS_DESKTOP_ARCH_OS_DIR="${CUCKOO_LAUNCHERS_DESKTOP_ARCH_DIR}${CUCKOO_OS}/"
