...
cuckoo_variables()
{
    ...
    CUCKOO_HD_TYPE="${CUCKOO_HD_TYPE:=$CUCKOO_EMULATOR_HD_TYPE_DEFAULT}"
...
cuckoo_variables_check()
{
    ...
    CUCKOO_ACTION="${CUCKOO_ACTION:=$CUCKOO_ACTION_DEFAULT}"

    case "$CUCKOO_ACTION" in
        run | install | iso-setup | hd-setup | config | desktop )

            CUCKOO_OS="${CUCKOO_OS:=$CUCKOO_OS_DEFAULT}"
            CUCKOO_DIST_VERSION="${CUCKOO_DIST_VERSION:=$CUCKOO_DIST_VERSION_DEFAULT}"
            CUCKOO_DIST_VERSION_DESKTOP_STYLE="${CUCKOO_DIST_VERSION_DESKTOP_STYLE:=$CUCKOO_DIST_VERSION_DESKTOP_STYLE_DEFAULT}"
