...
cuckoo_qemu_mapping()
{
    ...
    QEMU_ARCH="$VIRT_EMULATOR_ARCH"
    QEMU_OS="$VIRT_EMULATOR_OS"
    QEMU_ACTION="$VIRT_EMULATOR_ACTION"
    QEMU_SETUP_DIR="$VIRT_EMULATOR_SETUP_DIR"
    QEMU_BUILD_BRANCH="$VIRT_EMULATOR_VERSION"
    QEMU_VERSION="$VIRT_EMULATOR_VERSION"
    ...
    QEMU_TITLE=" Cuckoo -- ${CUCKOO_OS}[${CUCKOO_ARCH}] on ${VIRT_EMULATOR_OS_REAL}[${VIRT_EMULATOR_ARCH_REAL}] "
...
cuckoo_qemu_init()
{
    ...
    VIRT_EMULATOR_ARCH_REAL="$QEMU_ARCH"
    VIRT_EMULATOR_OS_REAL="$QEMU_OS"
