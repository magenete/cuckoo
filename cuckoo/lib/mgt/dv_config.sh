...
CUCKOO_EMULATOR_VERSION="$CUCKOO_EMULATOR_VERSION"
CUCKOO_EMULATOR_SYSTEM="$CUCKOO_EMULATOR_SYSTEM"
_C_O_F_I_G
}
...
cuckoo_dist_version_config_merge()
{
    ...
    CUCKOO_EMULATOR_VERSION__C_O_N_F_I_G="$CUCKOO_EMULATOR_VERSION"
    CUCKOO_EMULATOR_SYSTEM__C_O_N_F_I_G="$CUCKOO_EMULATOR_SYSTEM"

    cuckoo_dist_version_config_load

    [ "$CUCKOO_OS" != "$CUCKOO_OS__C_O_N_F_I_G" ] && CUCKOO_OS="$CUCKOO_OS__C_O_N_F_I_G"
    [ "$CUCKOO_ARCH" != "$CUCKOO_ARCH__C_O_N_F_I_G" ] && CUCKOO_ARCH="$CUCKOO_ARCH__C_O_N_F_I_G"
    ...
    [ "$CUCKOO_EMULATOR_VERSION" != "$CUCKOO_EMULATOR_VERSION__C_O_N_F_I_G" ] && CUCKOO_EMULATOR_VERSION="$CUCKOO_EMULATOR_VERSION__C_O_N_F_I_G"
    [ "$CUCKOO_EMULATOR_SYSTEM" != "$CUCKOO_EMULATOR_SYSTEM__C_O_N_F_I_G" ] && CUCKOO_EMULATOR_SYSTEM="$CUCKOO_EMULATOR_SYSTEM__C_O_N_F_I_G"
}
